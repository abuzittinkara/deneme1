...
declare module 'mongoose' {
  ...
  interface Model<
    ...
    TInstanceMethods = {},
    TVirtuals = {},
    THydratedDocumentType = Document<unknown, {}, TRawDocType> & Omit<TRawDocType & Document, 'typeKey'>,
    TModelSchema = any,
    TSchemaOptions = any,
    TTimestamps = any
  > {
    // Mongoose 6.x'te find() metodunun dönüş tipi için düzeltme
    find(filter?: any, projection?: any, options?: any): Query<Document[], Document, TQueryHelpers, TRawDocType>;

    // Mongoose 6.x'te findOne() metodunun dönüş tipi için düzeltme
    findOne(filter?: any, projection?: any, options?: any): Query<Document | null, Document, TQueryHelpers, TRawDocType>;

    // Mongoose 6.x'te findById() metodunun dönüş tipi için düzeltme
    findById(id: any, projection?: any, options?: any): Query<Document | null, Document, TQueryHelpers, TRawDocType>;

    // Mongoose 6.x'te findByIdAndUpdate() metodunun dönüş tipi için düzeltme
    findByIdAndUpdate(id: any, update: any, options?: any): Query<Document | null, Document, TQueryHelpers, TRawDocType>;

    // Mongoose 6.x'te findByIdAndDelete() metodunun dönüş tipi için düzeltme
    findByIdAndDelete(id: any, options?: any): Query<Document | null, Document, TQueryHelpers, TRawDocType>;

    // Mongoose 6.x'te updateOne() metodunun dönüş tipi için düzeltme
    updateOne(filter?: any, update?: any, options?: any): Query<any, Document, TQueryHelpers, TRawDocType>;

    // Mongoose 6.x'te updateMany() metodunun dönüş tipi için düzeltme
    updateMany(filter?: any, update?: any, options?: any): Query<any, Document, TQueryHelpers, TRawDocType>;
    ...
    countDocuments(filter?: any, options?: any): Query<number, Document, TQueryHelpers, TRawDocType>;
    ...
    findOneAndUpdate(filter?: any, update?: any, options?: any): Query<Document | null, Document, TQueryHelpers, TRawDocType>;
  }
}
